...
The legend (area C) can also be used to reduce the presented data to show the commodities (or food groups) of most interest to the user. When these are deselected, the name appears as a strikethrough font as shown in the image below, and the y axis of the graph recalculates to maximise the visible bars.
