...
[![QuickMAPS welcome and tour initial window](images/Landing_QuickMAPS_popup.png)](QuickMAPS welcome and tour initial window)The screen will then show the following view - which provides the user with the choice of country, micronutrient and, where applicable, food system or biomarker data.
