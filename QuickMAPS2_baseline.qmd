...
A map of the data is shown. Where food balance sheet data is presented, then there is only one summary value for the whole country (reflecting the input data, see methods ![](images/WiP_purplespanner.svg)). Where
